...
class Graph:
    ...
    def breadth_first_search(self, start, goal):
        found, fringe, visited, came_from = False, deque([start]), {start}, {start: None}
...
graph.add_edge('RimnicuVilcea', 'Sibiu')
graph.add_edge('RimnicuVilcea', 'Pitesti')
graph.add_edge('RimnicuVilcea', 'Craiova')
...
graph.add_edge('Pitesti', 'RimnicuVilcea')
